...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 0 auto;
            padding: 20px;
            background-color: #FFEDCC; /* Cambiar el color de fondo */
...
<body>
    <div class="container">
        <h2>Protagonistas de Rick y Morty</h2>
        <?php
        session_start();
        ...
        <div class="welcome-message">
            <?php echo "Welcome " . $_SESSION['username'] . "!"; ?> <a href="logout.php">Log Out</a>
        </div>
            ...
            if ($response) {
                ...
                if (!empty($characters['results'])) {
                    foreach ($characters['results'] as $character) {
                        ...
                        $pdfDownloadLink = '<a href="download_pdf.php?character_id=' . $character['id'] . '">Descargar ficha</a>';
                        ...
                        echo '<p class="favorite-form">' . $pdfDownloadLink . '</p>';
                        echo '</div>';
                        echo '<hr>';
                    }
                } else {
